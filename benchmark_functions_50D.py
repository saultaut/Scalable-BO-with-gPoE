...
if __name__ == '__main__':
    ...
    max_evals = 2000
    n_init = 100
    points_per_expert = 200
    prob_perturb = min(20.0 / NO_DIMENSIONS, 1.0)
        ...
        for model_name in model_list:
            ...
            for trial in range(N_TRIALS):
                ...
                models = {
                  ...
                  "gpoetrbo" : GPOETRBO(f=opt_function, points_per_expert=points_per_expert, n_init=n_init, prob_perturb=prob_perturb, perturb_rate=20, max_evals=max_evals, n_candidates=5000, batch_size=5000),
